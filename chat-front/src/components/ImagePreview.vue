<template>
    <div v-if="visible" class="overlay">
        <div class="image-container" @click.stop @wheel="handleWheel" @mousedown="handleMouseDown"
            :style="{ transform: `translate(${translateX}px, ${translateY}px) scale(${scale})` }" ref="imageContainer">
            <img :src="src" ref="imageRef" @load="handleImageLoad" />
