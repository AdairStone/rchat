  ...
  <div v-if="isOpen" class="modal box" @keydown="handleKeydown">
    <div class="modal-content">
      ...
      <div class="chat-header">
        <div class="chat-title">客戶编号：{{ roomKey }}</div>
        <!-- <div class="chat-time">{{ currentTime }}</div> -->
        <div class="chat-notify">会话编号：{{ roomId }}</div>
      </div>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const messages = computed(() => {
      // console.log("listened", messagesStore.messages);
      return messagesStore.messages[props.roomId] || [];
    });
